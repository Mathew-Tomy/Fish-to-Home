...
import 'package:fishtohome/screens/checkout/address_select.dart';
...
// Check if user is logged in, if not, show login alert
  void _checkLoginAndFetchCart() async {
    ...
    if (customerId == null || customerId.isEmpty) {
      ...
      _getCart();  // If logged in, fetch the cart
    }
  }
  ...
  void _showLoginAlert() {
    ...
    AlertDialog alert = AlertDialog(
      ...
      content: Text('You must log in to view your cart.', style: TextStyle(fontSize: 13, color: Colors.black)),
      actions: [
        cancelButton,
        loginButton,
      ],
